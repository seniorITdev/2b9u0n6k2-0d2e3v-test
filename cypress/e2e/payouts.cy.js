describe("Payouts", () => {
  ...
  it("Check result", () => {
    ...
    cy.get('[data-testid="name-input"]').type("asdfasdf");
    cy.get('[data-testid="amount-input"]').type("50");
    cy.get('[data-testid="add-expense-button"]').click();
    cy.get('[data-testid="trash-icon-0"]').click();
    cy.get('[data-testid="trash-icon-0"]').should("have.class", "fa-marked");
    cy.get('[data-testid="edit-icon-0"]').click();
    cy.get('[data-testid="edit-icon-0"]').should("have.class", "fa-marked");
    cy.get('[data-testid="check-icon-0"]').click();
    cy.get('[data-testid="check-icon-0"]').should("have.class", "fa-marked");
    // cy.get("")
  });
});
